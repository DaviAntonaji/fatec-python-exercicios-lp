...
Para fazer o cadastro em uma rede social, o usuário deve preencher vários dados, inclusive um e-mail válido, ou seja, um e-mail deve conter UM caracter arroba '@' e UM ou MAIS caracteres ponto '.'
